...
//    private int y = 300;
    ...
    public ReactTank(int x, int y, Dir dir, Group group, TankFrame tankFrame) {
        this.x = x;
        this.y = y;
        this.dir = dir;
        this.tankFrame = tankFrame;
...
//        g.fillRect(x,y,50,50);
    ...
    private void boundsCheck() {
        if (this.x < 2) x = 2;
        if (this.y < 28) y = 28;
        if (this.x > TankFrame.GAME_WIDTH- ReactTank.WIDTH -2) x = TankFrame.GAME_WIDTH - ReactTank.WIDTH -2;
        if (this.y > TankFrame.GAME_HEIGHT - ReactTank.HEIGHT -2 ) y = TankFrame.GAME_HEIGHT - ReactTank.HEIGHT -2;
    }
    public void die() {
        this.living = false;
    }
